...
from skak.v1.state import (
    Square, State, EMPTY, PAD, FILE_D, FILE_E, RANK_4, RANK_5,
...
class Ui:
    ...
    def blit_promotion(self, is_white):
        if is_white:
            self.place(self.white_queen, FILE_D, RANK_5)
            self.place(self.white_rook, FILE_E, RANK_5)
            self.place(self.white_bishop, FILE_D, RANK_4)
            self.place(self.white_knight, FILE_E, RANK_4)
        else:
            self.place(self.black_queen, FILE_D, RANK_5)
            self.place(self.black_rook, FILE_E, RANK_5)
            self.place(self.black_bishop, FILE_D, RANK_4)
            self.place(self.black_knight, FILE_E, RANK_4)
        self.place(self.move_overlay, FILE_D, RANK_5)
        self.place(self.move_overlay, FILE_E, RANK_5)
        self.place(self.move_overlay, FILE_D, RANK_4)
        self.place(self.move_overlay, FILE_E, RANK_4)
