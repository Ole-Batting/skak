...
def _viz(tree, x, b, linename):
    if len(tree.children) == 0:
        ...
        for i, (lan, (san, color, child)) in enumerate(tree.children.items()):
    ...
    if len(tree.children) == 0:
        ...
        for i, (lan, child) in enumerate(tree.children.items()):
            ...
            if len(tree.children) == 1:
                ...
                print(f"{URD}{san}", end="")
            _viz2(child, x+1, b+(int(i!=len(tree.children)-1)<<x), next_linename)
...
if __name__ == "__main__":
    ...
    a = Node(opening_name='a')
    b = Node(opening_name='b')
    c = Node(opening_name='c')
    d = Node(opening_name='d', children=[a,b])
    e = Node(opening_name='e', children=[d,c])
